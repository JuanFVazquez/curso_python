...
print(mi_moto.estado())              # Estado inicial
print(mi_moto.arrancar())            # Arrancar
print(mi_moto.acelerar())            # Acelerar
print(mi_moto.caballito())           # Hacer caballito
print(mi_moto.estado())              # Verificar que se refleja en el estado

print("--------Nuevo Objeto furgoneta-------")

mi_furgo = Furgoneta("Ford", "Transit")
print(mi_furgo.arrancar())
print(mi_furgo.carga(True))
print(mi_furgo.estado())

print("--------Nuevo Objeto bicicleta electrica-------")


mi_bici = BicicletaElectrica("Specialized", "Turbo Vado")
print(mi_bici.estado())
print(f"Autonomía: {mi_bici.autonomia} km")
print(mi_bici.cargarEnergia())
print(f"Autonomía tras carga: {mi_bici.autonomia} km")
